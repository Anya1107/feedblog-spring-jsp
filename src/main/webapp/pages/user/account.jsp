...
<div class="card text-center">
    ...
    <div class="card-body">
        ...
        <p class="card-text">User name: ${sessionScope.user.username}</p>
        <p class="card-text">Password: ${sessionScope.user.password}</p>
        <p class="card-text">Full name: ${sessionScope.user.fullName}</p>
        <p class="card-text">Count of followers: ${countOfFollowers}</p>
        <a href="/user/update" class="btn btn-primary">Update</a>
    </div>
</div>
