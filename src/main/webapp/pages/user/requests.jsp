...
<div class="card text-center">
    ...
    <div class="container">
        <c:forEach items="${unchecked}" var="unchecked">
            <div class="row justify-content-center m-3">
                <li class="list-group-item">${unchecked.username}</li>
            </div>
            <form action="/user/addFollower/${unchecked.id}" method="post">
                <button>Add</button>
            </form>
            <form action="/user/deleteFollower/${unchecked.id}" method="post">
